              ...
              <div key={tryon.id} className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-card transition-colors">
                <div className="relative aspect-[4/5] overflow-hidden bg-muted">
                  {tryon.status === "processing" ? (
                    <>
                      <img src={tryon.personImage} alt="" className="h-full w-full object-cover blur-sm opacity-50" />
                      <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-background/70">
                        <Loader2 className="size-5 animate-spin text-primary" />
                        <span className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">Подгонка...</span>
                      </div>
                    </>
                  ) : tryon.status === "failed" ? (
                    <>
                      <img src={tryon.personImage} alt="" className="h-full w-full object-cover opacity-20 grayscale" />
                    ...
                    <img src={tryon.resultImage} alt="Результат" className="h-full w-full object-cover" />
                  )}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
            <div className="flex max-h-[90vh] w-full max-w-lg flex-col rounded-2xl border border-border bg-card p-6">
              ...
              <div className="flex-1 overflow-hidden">
                <div className="mx-auto aspect-[4/5] max-w-sm overflow-hidden rounded-2xl border border-border bg-muted">
                  <img src={selectedTryon.resultImage} alt="Результат" className="h-full w-full object-cover" />
                  <div className="absolute bottom-3 right-3 flex gap-1">
                    <div className="size-8 overflow-hidden rounded-lg border border-border">
                      <img src={selectedTryon.personImage} alt="" className="h-full w-full object-cover" />
                    </div>
                    <div className="size-8 overflow-hidden rounded-lg border border-border">
                      <img src={selectedTryon.clothesImage} alt="" className="h-full w-full object-cover" />
                    </div>
                  </div>
                </div>
              </div>
